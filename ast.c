...
//                    printf("%*c第%d个实际参数表达式：\n",indent,' ',i);
  //                  display(T,indent+3);
                    printf("\n");
                    break;
    case INCREMENT: printf("%*c变量自增：\n",indent,' ');
                    printf("%*c变量名：%s\n",indent+3,' ',T->type_id);
                    display(T->ptr[0],indent+3);
                    break;
    case DECREMENT: printf("%*c变量自减：\n",indent,' ');
                    printf("%*c变量名：%s\n",indent+3,' ',T->type_id);
                    display(T->ptr[0],indent+3);
                    break;
    case FOR:       printf("%*cFor循环：\n",indent,' ');
                    display(T->ptr[0],indent+3);
                    printf("%*cFor循环体：\n",indent,' ');
                    display(T->ptr[1],indent+3);
                    break;
    case FOR_CONDITION: printf("%*cFor循环条件列表：\n",indent,' ');
                        display(T->ptr[0], indent+3);
                        display(T->ptr[1], indent+3);
    ...
    case STRUCT_DEF: printf("%*c结构体定义：\n",indent,' ');
                     ...
                     break;
    case STRUCT_VAR: printf("%*c结构体变量：%s\n",indent,' ', T->type_id);
                    printf("%*c结构体名称：\n",indent+3,' ');
                     display(T->ptr[0], indent+6);
                     printf("%*c结构体内部变量名称：\n",indent+3,' ');
                     display(T->ptr[1], indent+6);
                     break;
    case ARRAY_VAR: printf("%*c数组变量：\n",indent,' ');
                    printf("%*cID：%s\n",indent+3,' ', T->type_id);
                    printf("%*c访问地址：\n",indent+3,' ');
                    display(T->ptr[0],  indent+6);
                    break;
